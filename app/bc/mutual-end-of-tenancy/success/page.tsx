    ...
    async function load() {
      try {
        const pdfRes = await fetch(
          `/api/generate/bc-mutual-end-of-tenancy?token=${token}`
        );
        if (!pdfRes.ok) {
        ...
        a.href = url;
        a.download = "bc-mutual-agreement-to-end-tenancy.pdf";
    ...
    <main className="min-h-screen px-4 py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <LCSection
          ...
          description="Your Mutual Agreement to End Tenancy has been generated and downloaded."
