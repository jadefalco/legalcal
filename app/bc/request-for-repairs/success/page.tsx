    ...
    async function load() {
      try {
        const pdfRes = await fetch(
          `/api/generate/bc-request-for-repairs?token=${token}`
        );
        if (!pdfRes.ok) {
        ...
        a.href = url;
        a.download = "bc-request-for-repairs.pdf";
    ...
    <main className="min-h-screen px-4 py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <LCSection
          ...
          description="Your Request for Repairs Letter has been generated and downloaded."
