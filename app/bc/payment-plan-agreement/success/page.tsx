    ...
    async function load() {
      try {
        const pdfRes = await fetch(
          `/api/generate/bc-payment-plan-agreement?token=${token}`
        );
        if (!pdfRes.ok) {
        ...
        a.href = url;
        a.download = "bc-payment-plan-agreement.pdf";
    ...
    <main className="min-h-screen px-4 py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <LCSection
          ...
          description="Your Payment Plan Agreement has been generated and downloaded."
