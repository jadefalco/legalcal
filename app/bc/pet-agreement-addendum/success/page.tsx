    ...
    async function load() {
      try {
        const pdfRes = await fetch(
          `/api/generate/bc-pet-agreement-addendum?token=${token}`
        );
        if (!pdfRes.ok) {
        ...
        a.href = url;
        a.download = "bc-pet-agreement-addendum.pdf";
    ...
    <main className="min-h-screen px-4 py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <LCSection
          ...
          description="Your Pet Agreement Addendum has been generated and downloaded."
