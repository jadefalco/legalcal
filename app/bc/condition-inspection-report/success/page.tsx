    ...
    async function load() {
      try {
        const pdfRes = await fetch(
          `/api/generate/bc-condition-inspection-report?token=${token}`
        );
        if (!pdfRes.ok) {
        ...
        a.href = url;
        a.download = "bc-condition-inspection-report.pdf";
    ...
    <main className="min-h-screen px-4 py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <LCSection
          ...
          description="Your Condition Inspection Report has been generated and downloaded."
