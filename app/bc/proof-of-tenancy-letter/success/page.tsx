    ...
    async function load() {
      try {
        const pdfRes = await fetch(
          `/api/generate/bc-proof-of-tenancy-letter?token=${token}`
        );
        if (!pdfRes.ok) {
        ...
        a.href = url;
        a.download = "bc-proof-of-tenancy-letter.pdf";
    ...
    <main className="min-h-screen px-4 py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <LCSection
          ...
          description="Your Proof of Tenancy Letter has been generated and downloaded."
