    ...
    async function load() {
      try {
        const pdfRes = await fetch(
          `/api/generate/bc-rent-arrears-statement?token=${token}`
        );
        if (!pdfRes.ok) {
        ...
        a.href = url;
        a.download = "bc-rent-arrears-statement.pdf";
    ...
    <main className="min-h-screen px-4 py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <LCSection
          ...
          description="Your Rent Arrears Statement has been generated and downloaded."
