  ...
  return (
    <div className="space-y-8">
      <LCSection
        ...
        description="Select a state to view overtime calculator rules and calculate deadlines."
        icon={CalculatorIcon}
        theme={theme}
      />
      ...
      <LCCard theme={theme} className="space-y-6">
        ...
        <Link href={`/calculators/us/${stateCode}/overtime-calculator`}>
          <LCButton variant="primary" theme={theme}>
            <ArrowRightCircleIcon className="w-4 h-4" />
            View State-Specific Overtime Calculator Calculator
          </LCButton>
        </Link>
      </LCCard>
    </div>
