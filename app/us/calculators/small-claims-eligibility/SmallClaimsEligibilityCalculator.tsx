  ...
  return (
    <div className="space-y-8">
      <LCSection
        ...
        description="Select a state to view small claims eligibility rules and calculate deadlines."
        icon={CalculatorIcon}
        theme={theme}
      />
      ...
      <LCCard theme={theme} className="space-y-6">
        ...
        <Link href={`/calculators/us/${stateCode}/small-claims-eligibility`}>
          <LCButton variant="primary" theme={theme}>
            <ArrowRightCircleIcon className="w-4 h-4" />
            View State-Specific Small Claims Eligibility Calculator
          </LCButton>
        </Link>
      </LCCard>
    </div>
