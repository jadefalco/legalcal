...
export default function ABNoticeToEnterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/checkout/ab-notice-to-enter", {
        method: "POST",
  ...
  return (
    <main className="min-h-screen px-4 py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <LCSection
          title="Alberta Notice to Enter"
          description="Generate a notice to enter rental premises under the Alberta Residential Tenancies Act."
