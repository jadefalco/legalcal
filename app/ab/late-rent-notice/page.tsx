...
export default function ABLateRentNoticePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const res = await fetch("/api/checkout/ab-late-rent-notice", {
        method: "POST",
  ...
  return (
    <main className="min-h-screen px-4 py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <LCSection
          title="Alberta Late Rent Notice"
          description="Generate a late rent notice under the Alberta Residential Tenancies Act."
