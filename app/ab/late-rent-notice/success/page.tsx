    ...
    async function load() {
      try {
        const pdfRes = await fetch(
          `/api/generate/ab-late-rent-notice?token=${token}`
        );
        if (!pdfRes.ok) {
        ...
        a.href = url;
        a.download = "ab-late-rent-notice.pdf";
    ...
    <main className="min-h-screen px-4 py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <LCSection
          ...
          description="Your Alberta Late Rent Notice has been generated and downloaded."
