    ...
    async function load() {
      try {
        const pdfRes = await fetch(
          `/api/generate/ab-eviction-14-day?token=${token}`
        );
        if (!pdfRes.ok) {
        ...
        a.href = url;
        a.download = "ab-eviction-14-day.pdf";
    ...
    <main className="min-h-screen px-4 py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <LCSection
          ...
          description="Your Alberta 14-Day Eviction Notice has been generated and downloaded."
