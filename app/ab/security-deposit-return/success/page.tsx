    ...
    async function load() {
      try {
        const pdfRes = await fetch(
          `/api/generate/ab-security-deposit-return?token=${token}`
        );
        if (!pdfRes.ok) {
        ...
        a.href = url;
        a.download = "ab-security-deposit-return.pdf";
    ...
    <main className="min-h-screen px-4 py-10 max-w-4xl mx-auto">
      <div className="space-y-8">
        <LCSection
          ...
          description="Your Alberta Security Deposit Return Statement has been generated and downloaded."
