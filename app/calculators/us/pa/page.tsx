...
const state = usStates["pa"];

export const metadata: Metadata = {
  title: "Pennsylvania Legal Calculators",
  description:
    "Free legal calculators for Pennsylvania. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/pa",
  },
  openGraph: {
    title: "Pennsylvania Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for Pennsylvania. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/pa",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Pennsylvania",
      item: "https://your-domain.com/calculators/us/pa",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              Pennsylvania Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for Pennsylvania. Estimate deadlines,
            notice periods, and eligibility under Pennsylvania law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/pa/${calc.slug}`}
