...
export const metadata: Metadata = {
  title: "Delaware Legal Calculators",
  description:
    "Free legal calculators for Delaware. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/de",
  },
  openGraph: {
    title: "Delaware Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for Delaware. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/de",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Delaware",
      item: "https://your-domain.com/calculators/us/de",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            <Image
              src="/seals/us/de.png"
              alt="Delaware state seal"
              width={60}
              height={60}
              className="opacity-80"
            />
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              Delaware Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for Delaware. Estimate deadlines,
            notice periods, and eligibility under Delaware law.
          </p>
          <div
            className="mt-3 w-20 h-1 rounded-full"
            style={{ backgroundColor: "#0074AD" }}
          />
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/de/${calc.slug}`}
