...
const state = usStates["ks"];

export const metadata: Metadata = {
  title: "Kansas Legal Calculators",
  description:
    "Free legal calculators for Kansas. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/ks",
  },
  openGraph: {
    title: "Kansas Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for Kansas. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/ks",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Kansas",
      item: "https://your-domain.com/calculators/us/ks",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              Kansas Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for Kansas. Estimate deadlines,
            notice periods, and eligibility under Kansas law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/ks/${calc.slug}`}
