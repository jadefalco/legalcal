...
export const metadata: Metadata = {
  title: "North Dakota Legal Calculators",
  description:
    "Free legal calculators for North Dakota. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/nd",
  },
  openGraph: {
    title: "North Dakota Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for North Dakota. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/nd",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "North Dakota",
      item: "https://your-domain.com/calculators/us/nd",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            <Image
              src="/seals/us/nd.png"
              alt="North Dakota state seal"
              width={60}
              height={60}
              className="opacity-80"
            />
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              North Dakota Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for North Dakota. Estimate deadlines,
            notice periods, and eligibility under North Dakota law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/nd/${calc.slug}`}
