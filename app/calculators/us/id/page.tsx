...
const state = usStates["id"];

export const metadata: Metadata = {
  title: "Idaho Legal Calculators",
  description:
    "Free legal calculators for Idaho. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/id",
  },
  openGraph: {
    title: "Idaho Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for Idaho. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/id",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Idaho",
      item: "https://your-domain.com/calculators/us/id",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              Idaho Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for Idaho. Estimate deadlines,
            notice periods, and eligibility under Idaho law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/id/${calc.slug}`}
