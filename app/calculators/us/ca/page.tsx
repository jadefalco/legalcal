...
export const metadata: Metadata = {
  title: "California Legal Calculators",
  description:
    "Free legal calculators for California. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/ca",
  },
  openGraph: {
    title: "California Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for California. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/ca",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "California",
      item: "https://your-domain.com/calculators/us/ca",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              California Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for California. Estimate deadlines,
            notice periods, and eligibility under California law.
          </p>
          <div
            className="mt-3 w-20 h-1 rounded-full"
            style={{ backgroundColor: "#FCB813" }}
          />
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/ca/${calc.slug}`}
