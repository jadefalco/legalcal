...
const state = usStates["wv"];

export const metadata: Metadata = {
  title: "West Virginia Legal Calculators",
  description:
    "Free legal calculators for West Virginia. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/wv",
  },
  openGraph: {
    title: "West Virginia Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for West Virginia. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/wv",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "West Virginia",
      item: "https://your-domain.com/calculators/us/wv",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              West Virginia Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for West Virginia. Estimate deadlines,
            notice periods, and eligibility under West Virginia law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/wv/${calc.slug}`}
