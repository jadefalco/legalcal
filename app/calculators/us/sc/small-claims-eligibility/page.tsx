...
const state: USState = usStates["sc"];
const theme: Theme = getTheme("us", "sc");

export const metadata: Metadata = {
  title: "South Carolina – Small Claims Eligibility Calculator",
  ...
  return (
    <StateThemeProvider state={state}>
      ...
      <div className="max-w-3xl mx-auto px-6 py-10">
        <StateHeader
          title={`${state.name} Small Claims Eligibility Calculator`}
          description="Explain small claims court eligibility, limits, and filing procedures."
        />
