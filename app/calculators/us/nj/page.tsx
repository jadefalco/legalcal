...
const state = usStates["nj"];

export const metadata: Metadata = {
  title: "New Jersey Legal Calculators",
  description:
    "Free legal calculators for New Jersey. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/nj",
  },
  openGraph: {
    title: "New Jersey Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for New Jersey. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/nj",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "New Jersey",
      item: "https://your-domain.com/calculators/us/nj",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          ...
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for New Jersey. Estimate deadlines,
            notice periods, and eligibility under New Jersey law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/nj/${calc.slug}`}
