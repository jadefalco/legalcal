...
const state = usStates["il"];

export const metadata: Metadata = {
  title: "Illinois Legal Calculators",
  description:
    "Free legal calculators for Illinois. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/il",
  },
  openGraph: {
    title: "Illinois Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for Illinois. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/il",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Illinois",
      item: "https://your-domain.com/calculators/us/il",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              Illinois Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for Illinois. Estimate deadlines,
            notice periods, and eligibility under Illinois law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/il/${calc.slug}`}
