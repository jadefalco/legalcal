...
const state = usStates["mn"];

export const metadata: Metadata = {
  title: "Minnesota Legal Calculators",
  description:
    "Free legal calculators for Minnesota. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/mn",
  },
  openGraph: {
    title: "Minnesota Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for Minnesota. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/mn",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Minnesota",
      item: "https://your-domain.com/calculators/us/mn",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              Minnesota Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for Minnesota. Estimate deadlines,
            notice periods, and eligibility under Minnesota law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/mn/${calc.slug}`}
