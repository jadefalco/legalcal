...
const state = usStates["nh"];

export const metadata: Metadata = {
  title: "New Hampshire Legal Calculators",
  description:
    "Free legal calculators for New Hampshire. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/nh",
  },
  openGraph: {
    title: "New Hampshire Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for New Hampshire. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/nh",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "New Hampshire",
      item: "https://your-domain.com/calculators/us/nh",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              New Hampshire Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for New Hampshire. Estimate deadlines,
            notice periods, and eligibility under New Hampshire law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/nh/${calc.slug}`}
