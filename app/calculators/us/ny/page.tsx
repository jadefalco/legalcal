...
const state = usStates["ny"];

export const metadata: Metadata = {
  title: "New York Legal Calculators",
  description:
    "Free legal calculators for New York. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/ny",
  },
  openGraph: {
    title: "New York Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for New York. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/ny",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "New York",
      item: "https://your-domain.com/calculators/us/ny",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          ...
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for New York. Estimate deadlines,
            notice periods, and eligibility under New York law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/ny/${calc.slug}`}
