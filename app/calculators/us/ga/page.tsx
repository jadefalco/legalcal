...
export const metadata: Metadata = {
  title: "Georgia Legal Calculators",
  description:
    "Free legal calculators for Georgia. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/ga",
  },
  openGraph: {
    title: "Georgia Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for Georgia. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/ga",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Georgia",
      item: "https://your-domain.com/calculators/us/ga",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          ...
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for Georgia. Estimate deadlines,
            notice periods, and eligibility under Georgia law.
          </p>
          <div
            className="mt-3 w-20 h-1 rounded-full"
            style={{ backgroundColor: "#B5002D" }}
          />
        </div>
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/ga/${calc.slug}`}
