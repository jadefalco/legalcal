...
export const metadata: Metadata = {
  ...
  description:
    "Alberta notice period calculator coming soon. Use our BC notice period calculator in the meantime.",
  alternates: {
...
export default function AlbertaNoticePeriodPlaceholder() {
  return (
