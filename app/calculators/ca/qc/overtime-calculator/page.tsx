...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/qc/overtime-calculator",
  },
  openGraph: {
    title: "Quebec – Overtime Calculator Calculator | Legal Calculators",
    description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/qc/overtime-calculator",
  },
};
