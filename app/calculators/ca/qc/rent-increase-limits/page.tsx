...
export const metadata: Metadata = {
  title: "Quebec – Rent Increase Limits Calculator",
  description: "Explain rent increase limits, notice requirements, and exemption rules.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/qc/rent-increase-limits",
  },
  openGraph: {
    title: "Quebec – Rent Increase Limits Calculator | Legal Calculators",
    description: "Explain rent increase limits, notice requirements, and exemption rules.",
    url: "https://your-domain.com/calculators/ca/qc/rent-increase-limits",
  },
};
