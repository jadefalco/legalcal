...
export const metadata: Metadata = {
  title: "Quebec – Eviction Timeline Calculator",
  description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/qc/eviction-timeline",
  },
  openGraph: {
    title: "Quebec – Eviction Timeline Calculator | Legal Calculators",
    description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/qc/eviction-timeline",
  },
};
