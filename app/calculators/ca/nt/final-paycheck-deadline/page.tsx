...
export const metadata: Metadata = {
  title: "Northwest Territories – Final Paycheck Deadline Calculator",
  description: "Calculate final paycheck deadlines and accrued vacation payouts.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nt/final-paycheck-deadline",
  },
  openGraph: {
    title: "Northwest Territories – Final Paycheck Deadline Calculator | Legal Calculators",
    description: "Calculate final paycheck deadlines and accrued vacation payouts.",
    url: "https://your-domain.com/calculators/ca/nt/final-paycheck-deadline",
  },
};
