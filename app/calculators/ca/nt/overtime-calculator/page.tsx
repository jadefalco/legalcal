...
export const metadata: Metadata = {
  title: "Northwest Territories – Overtime Calculator Calculator",
  description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nt/overtime-calculator",
  },
  openGraph: {
    title: "Northwest Territories – Overtime Calculator Calculator | Legal Calculators",
    description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/nt/overtime-calculator",
  },
};
