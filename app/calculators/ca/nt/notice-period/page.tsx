...
export const metadata: Metadata = {
  title: "Northwest Territories – Notice Period Calculator",
  description: "Calculate notice period requirements for residential and employment terminations.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nt/notice-period",
  },
  openGraph: {
    title: "Northwest Territories – Notice Period Calculator | Legal Calculators",
    description: "Calculate notice period requirements for residential and employment terminations.",
    url: "https://your-domain.com/calculators/ca/nt/notice-period",
  },
};
