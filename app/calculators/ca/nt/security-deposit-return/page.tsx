...
export const metadata: Metadata = {
  title: "Northwest Territories – Security Deposit Return Calculator",
  description: "Calculate security deposit return deadlines and allowable deductions.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nt/security-deposit-return",
  },
  openGraph: {
    title: "Northwest Territories – Security Deposit Return Calculator | Legal Calculators",
    description: "Calculate security deposit return deadlines and allowable deductions.",
    url: "https://your-domain.com/calculators/ca/nt/security-deposit-return",
  },
};
