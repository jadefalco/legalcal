...
const province: CAProvince = caProvinces["nt"];
const theme: Theme = getTheme("ca", "nt");

export const metadata: Metadata = {
  title: "Northwest Territories – Small Claims Eligibility Calculator",
  description: "Explain small claims court eligibility, limits, and filing procedures.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nt/small-claims-eligibility",
  },
  openGraph: {
    title: "Northwest Territories – Small Claims Eligibility Calculator | Legal Calculators",
    description: "Explain small claims court eligibility, limits, and filing procedures.",
    url: "https://your-domain.com/calculators/ca/nt/small-claims-eligibility",
  },
};
