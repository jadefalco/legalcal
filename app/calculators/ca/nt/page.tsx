...
export const metadata: Metadata = {
  title: "Northwest Territories Legal Calculators",
  description:
    "Free legal calculators for Northwest Territories. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nt",
  },
  openGraph: {
    title: "Northwest Territories Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for Northwest Territories. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/ca/nt",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: "https://your-domain.com/calculators/ca/nt",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            <Image
              src="/seals/ca/nt.png"
              alt="Northwest Territories seal"
              width={60}
              height={60}
              className="opacity-80"
            />
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              Northwest Territories Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for Northwest Territories. Estimate deadlines,
            notice periods, and eligibility under Northwest Territories law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/ca/nt/${calc.slug}`}
