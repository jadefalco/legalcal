...
export const metadata: Metadata = {
  title: "Northwest Territories – Eviction Timeline Calculator",
  description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nt/eviction-timeline",
  },
  openGraph: {
    title: "Northwest Territories – Eviction Timeline Calculator | Legal Calculators",
    description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/nt/eviction-timeline",
  },
};
