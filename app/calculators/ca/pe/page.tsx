...
const province = caProvinces["pe"];

export const metadata: Metadata = {
  title: "Prince Edward Island Legal Calculators",
  description:
    "Free legal calculators for Prince Edward Island. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/pe",
  },
  openGraph: {
    title: "Prince Edward Island Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for Prince Edward Island. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/ca/pe",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: "https://your-domain.com/calculators/ca/pe",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              Prince Edward Island Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for Prince Edward Island. Estimate deadlines,
            notice periods, and eligibility under Prince Edward Island law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/ca/pe/${calc.slug}`}
