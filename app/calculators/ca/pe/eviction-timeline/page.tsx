...
export const metadata: Metadata = {
  title: "Prince Edward Island – Eviction Timeline Calculator",
  description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/pe/eviction-timeline",
  },
  openGraph: {
    title: "Prince Edward Island – Eviction Timeline Calculator | Legal Calculators",
    description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/pe/eviction-timeline",
  },
};
