...
export const metadata = {
  title: "Eviction Timeline for PE | LegalCals",
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      <div className="px-4 py-12 max-w-4xl mx-auto space-y-6">
        <RuleFreshnessBanner topic="eviction-timeline" jurisdiction="pe" />
        <div className="rounded-lg border border-slate-200 bg-white p-8 text-center space-y-4">
          <h1 className="text-2xl font-bold text-slate-900">Eviction Timeline</h1>
          ...
          <div className="pt-2">
            <Link
              href="/admin/rules/eviction-timeline/pe"
