...
export const metadata: Metadata = {
  title: "Prince Edward Island – Overtime Calculator Calculator",
  description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/pe/overtime-calculator",
  },
  openGraph: {
    title: "Prince Edward Island – Overtime Calculator Calculator | Legal Calculators",
    description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/pe/overtime-calculator",
  },
};
