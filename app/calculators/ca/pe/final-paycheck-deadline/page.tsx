...
export const metadata: Metadata = {
  title: "Prince Edward Island – Final Paycheck Deadline Calculator",
  description: "Calculate final paycheck deadlines and accrued vacation payouts.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/pe/final-paycheck-deadline",
  },
  openGraph: {
    title: "Prince Edward Island – Final Paycheck Deadline Calculator | Legal Calculators",
    description: "Calculate final paycheck deadlines and accrued vacation payouts.",
    url: "https://your-domain.com/calculators/ca/pe/final-paycheck-deadline",
  },
};
