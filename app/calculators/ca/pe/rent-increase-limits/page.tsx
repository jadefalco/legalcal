...
export const metadata: Metadata = {
  title: "Prince Edward Island – Rent Increase Limits Calculator",
  description: "Explain rent increase limits, notice requirements, and exemption rules.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/pe/rent-increase-limits",
  },
  openGraph: {
    title: "Prince Edward Island – Rent Increase Limits Calculator | Legal Calculators",
    description: "Explain rent increase limits, notice requirements, and exemption rules.",
    url: "https://your-domain.com/calculators/ca/pe/rent-increase-limits",
  },
};
