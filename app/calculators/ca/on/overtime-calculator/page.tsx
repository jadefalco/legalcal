...
export const metadata: Metadata = {
  title: "Ontario – Overtime Calculator Calculator",
  description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/on/overtime-calculator",
  },
  openGraph: {
    title: "Ontario – Overtime Calculator Calculator | Legal Calculators",
    description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/on/overtime-calculator",
  },
};
