...
export const metadata: Metadata = {
  title: "Ontario – Small Claims Eligibility Calculator",
  description: "Explain small claims court eligibility, limits, and filing procedures.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/on/small-claims-eligibility",
  },
  openGraph: {
    title: "Ontario – Small Claims Eligibility Calculator | Legal Calculators",
    description: "Explain small claims court eligibility, limits, and filing procedures.",
    url: "https://your-domain.com/calculators/ca/on/small-claims-eligibility",
  },
};
