...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/on/notice-period",
  },
  openGraph: {
    title: "Ontario – Notice Period Calculator | Legal Calculators",
    description: "Calculate notice period requirements for residential and employment terminations.",
    url: "https://your-domain.com/calculators/ca/on/notice-period",
  },
};
