...
export const metadata = {
  title: "Repair Request for ON | LegalCals",
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      <div className="px-4 py-12 max-w-4xl mx-auto space-y-6">
        <RuleFreshnessBanner topic="repair-request" jurisdiction="on" />
        <div className="rounded-lg border border-slate-200 bg-white p-8 text-center space-y-4">
          <h1 className="text-2xl font-bold text-slate-900">Repair Request</h1>
          ...
          <div className="pt-2">
            <Link
              href="/admin/rules/repair-request/on"
