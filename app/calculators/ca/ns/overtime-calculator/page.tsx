...
export const metadata: Metadata = {
  title: "Nova Scotia – Overtime Calculator Calculator",
  description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/ns/overtime-calculator",
  },
  openGraph: {
    title: "Nova Scotia – Overtime Calculator Calculator | Legal Calculators",
    description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/ns/overtime-calculator",
  },
};
