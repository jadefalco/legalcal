...
export const metadata: Metadata = {
  title: "Nova Scotia – Eviction Timeline Calculator",
  description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/ns/eviction-timeline",
  },
  openGraph: {
    title: "Nova Scotia – Eviction Timeline Calculator | Legal Calculators",
    description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/ns/eviction-timeline",
  },
};
