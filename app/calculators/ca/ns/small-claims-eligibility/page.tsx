...
const province: CAProvince = caProvinces["ns"];
const theme: Theme = getTheme("ca", "ns");

export const metadata: Metadata = {
  title: "Nova Scotia – Small Claims Eligibility Calculator",
  description: "Explain small claims court eligibility, limits, and filing procedures.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/ns/small-claims-eligibility",
  },
  openGraph: {
    title: "Nova Scotia – Small Claims Eligibility Calculator | Legal Calculators",
    description: "Explain small claims court eligibility, limits, and filing procedures.",
    url: "https://your-domain.com/calculators/ca/ns/small-claims-eligibility",
  },
};
