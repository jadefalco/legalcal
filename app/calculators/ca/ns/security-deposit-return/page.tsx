...
export const metadata: Metadata = {
  title: "Nova Scotia – Security Deposit Return Calculator",
  description: "Calculate security deposit return deadlines and allowable deductions.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/ns/security-deposit-return",
  },
  openGraph: {
    title: "Nova Scotia – Security Deposit Return Calculator | Legal Calculators",
    description: "Calculate security deposit return deadlines and allowable deductions.",
    url: "https://your-domain.com/calculators/ca/ns/security-deposit-return",
  },
};
