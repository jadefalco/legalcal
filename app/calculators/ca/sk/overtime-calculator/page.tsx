...
export const metadata: Metadata = {
  title: "Saskatchewan – Overtime Calculator Calculator",
  description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/sk/overtime-calculator",
  },
  openGraph: {
    title: "Saskatchewan – Overtime Calculator Calculator | Legal Calculators",
    description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/sk/overtime-calculator",
  },
};
