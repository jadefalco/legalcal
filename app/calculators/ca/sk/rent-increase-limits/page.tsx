...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/sk/rent-increase-limits",
  },
  openGraph: {
    title: "Saskatchewan – Rent Increase Limits Calculator | Legal Calculators",
    description: "Explain rent increase limits, notice requirements, and exemption rules.",
    url: "https://your-domain.com/calculators/ca/sk/rent-increase-limits",
  },
};
