...
export const metadata: Metadata = {
  title: "Saskatchewan – Final Paycheck Deadline Calculator",
  description: "Calculate final paycheck deadlines and accrued vacation payouts.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/sk/final-paycheck-deadline",
  },
  openGraph: {
    title: "Saskatchewan – Final Paycheck Deadline Calculator | Legal Calculators",
    description: "Calculate final paycheck deadlines and accrued vacation payouts.",
    url: "https://your-domain.com/calculators/ca/sk/final-paycheck-deadline",
  },
};
