...
export const metadata: Metadata = {
  title: "New Brunswick – Eviction Timeline Calculator",
  description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nb/eviction-timeline",
  },
  openGraph: {
    title: "New Brunswick – Eviction Timeline Calculator | Legal Calculators",
    description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/nb/eviction-timeline",
  },
};
