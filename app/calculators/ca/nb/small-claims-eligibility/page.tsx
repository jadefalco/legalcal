...
const province: CAProvince = caProvinces["nb"];
const theme: Theme = getTheme("ca", "nb");

export const metadata: Metadata = {
  title: "New Brunswick – Small Claims Eligibility Calculator",
  description: "Explain small claims court eligibility, limits, and filing procedures.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nb/small-claims-eligibility",
  },
  openGraph: {
    title: "New Brunswick – Small Claims Eligibility Calculator | Legal Calculators",
    description: "Explain small claims court eligibility, limits, and filing procedures.",
    url: "https://your-domain.com/calculators/ca/nb/small-claims-eligibility",
  },
};
