...
export const metadata: Metadata = {
  title: "New Brunswick – Overtime Calculator Calculator",
  description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nb/overtime-calculator",
  },
  openGraph: {
    title: "New Brunswick – Overtime Calculator Calculator | Legal Calculators",
    description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/nb/overtime-calculator",
  },
};
