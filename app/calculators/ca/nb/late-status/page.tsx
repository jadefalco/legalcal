...
export const metadata = {
  title: "Late Status for NB | LegalCals",
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      <div className="px-4 py-12 max-w-4xl mx-auto space-y-6">
        <RuleFreshnessBanner topic="late-status" jurisdiction="nb" />
        <div className="rounded-lg border border-slate-200 bg-white p-8 text-center space-y-4">
          <h1 className="text-2xl font-bold text-slate-900">Late Status</h1>
          ...
          <div className="pt-2">
            <Link
              href="/admin/rules/late-status/nb"
