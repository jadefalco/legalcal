...
export const metadata: Metadata = {
  title: "Nunavut – Final Paycheck Deadline Calculator",
  description: "Calculate final paycheck deadlines and accrued vacation payouts.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nu/final-paycheck-deadline",
  },
  openGraph: {
    title: "Nunavut – Final Paycheck Deadline Calculator | Legal Calculators",
    description: "Calculate final paycheck deadlines and accrued vacation payouts.",
    url: "https://your-domain.com/calculators/ca/nu/final-paycheck-deadline",
  },
};
