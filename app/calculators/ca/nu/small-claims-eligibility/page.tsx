...
const province: CAProvince = caProvinces["nu"];
const theme: Theme = getTheme("ca", "nu");

export const metadata: Metadata = {
  title: "Nunavut – Small Claims Eligibility Calculator",
  description: "Explain small claims court eligibility, limits, and filing procedures.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nu/small-claims-eligibility",
  },
  openGraph: {
    title: "Nunavut – Small Claims Eligibility Calculator | Legal Calculators",
    description: "Explain small claims court eligibility, limits, and filing procedures.",
    url: "https://your-domain.com/calculators/ca/nu/small-claims-eligibility",
  },
};
