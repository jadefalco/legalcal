...
export const metadata: Metadata = {
  title: "Nunavut – Notice Period Calculator",
  description: "Calculate notice period requirements for residential and employment terminations.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nu/notice-period",
  },
  openGraph: {
    title: "Nunavut – Notice Period Calculator | Legal Calculators",
    description: "Calculate notice period requirements for residential and employment terminations.",
    url: "https://your-domain.com/calculators/ca/nu/notice-period",
  },
};
