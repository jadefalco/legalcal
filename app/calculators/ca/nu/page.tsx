...
const province = caProvinces["nu"];

export const metadata: Metadata = {
  title: "Nunavut Legal Calculators",
  description:
    "Free legal calculators for Nunavut. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nu",
  },
  openGraph: {
    title: "Nunavut Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for Nunavut. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/ca/nu",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "Nunavut",
      item: "https://your-domain.com/calculators/ca/nu",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          <div className="flex items-center gap-4 mb-4">
            ...
            <h1 className="text-3xl md:text-4xl font-serif text-navy">
              Nunavut Legal Calculators
            </h1>
          </div>
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for Nunavut. Estimate deadlines,
            notice periods, and eligibility under Nunavut law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/ca/nu/${calc.slug}`}
