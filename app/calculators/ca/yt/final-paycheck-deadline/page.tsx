...
export const metadata: Metadata = {
  title: "Yukon – Final Paycheck Deadline Calculator",
  description: "Calculate final paycheck deadlines and accrued vacation payouts.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/yt/final-paycheck-deadline",
  },
  openGraph: {
    title: "Yukon – Final Paycheck Deadline Calculator | Legal Calculators",
    description: "Calculate final paycheck deadlines and accrued vacation payouts.",
    url: "https://your-domain.com/calculators/ca/yt/final-paycheck-deadline",
  },
};
