...
export const metadata: Metadata = {
  title: "Yukon – Rent Increase Limits Calculator",
  description: "Explain rent increase limits, notice requirements, and exemption rules.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/yt/rent-increase-limits",
  },
  openGraph: {
    title: "Yukon – Rent Increase Limits Calculator | Legal Calculators",
    description: "Explain rent increase limits, notice requirements, and exemption rules.",
    url: "https://your-domain.com/calculators/ca/yt/rent-increase-limits",
  },
};
