...
export const metadata = {
  title: "Condition Inspection for NL | LegalCals",
  description: "This calculator is coming soon for NL.",
};
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      <div className="px-4 py-12 max-w-4xl mx-auto space-y-6">
        <RuleFreshnessBanner topic="condition-inspection" jurisdiction="nl" />
        <div className="rounded-lg border border-slate-200 bg-white p-8 text-center space-y-4">
          ...
          <div className="pt-2">
            <Link
              href="/admin/rules/condition-inspection/nl"
