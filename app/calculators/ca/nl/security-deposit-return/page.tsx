...
export const metadata: Metadata = {
  title: "Newfoundland and Labrador – Security Deposit Return Calculator",
  description: "Calculate security deposit return deadlines and allowable deductions.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nl/security-deposit-return",
  },
  openGraph: {
    title: "Newfoundland and Labrador – Security Deposit Return Calculator | Legal Calculators",
    description: "Calculate security deposit return deadlines and allowable deductions.",
    url: "https://your-domain.com/calculators/ca/nl/security-deposit-return",
  },
};
