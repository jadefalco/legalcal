...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nl/small-claims-eligibility",
  },
  openGraph: {
    title: "Newfoundland and Labrador – Small Claims Eligibility Calculator | Legal Calculators",
    description: "Explain small claims court eligibility, limits, and filing procedures.",
    url: "https://your-domain.com/calculators/ca/nl/small-claims-eligibility",
  },
};
