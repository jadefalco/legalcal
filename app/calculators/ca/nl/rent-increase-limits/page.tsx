...
export const metadata: Metadata = {
  title: "Newfoundland and Labrador – Rent Increase Limits Calculator",
  description: "Explain rent increase limits, notice requirements, and exemption rules.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nl/rent-increase-limits",
  },
  openGraph: {
    title: "Newfoundland and Labrador – Rent Increase Limits Calculator | Legal Calculators",
    description: "Explain rent increase limits, notice requirements, and exemption rules.",
    url: "https://your-domain.com/calculators/ca/nl/rent-increase-limits",
  },
};
