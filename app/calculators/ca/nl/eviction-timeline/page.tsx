...
export const metadata: Metadata = {
  title: "Newfoundland and Labrador – Eviction Timeline Calculator",
  description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nl/eviction-timeline",
  },
  openGraph: {
    title: "Newfoundland and Labrador – Eviction Timeline Calculator | Legal Calculators",
    description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/nl/eviction-timeline",
  },
};
