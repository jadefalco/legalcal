...
export const metadata: Metadata = {
  title: "Newfoundland and Labrador – Notice Period Calculator",
  description: "Calculate notice period requirements for residential and employment terminations.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nl/notice-period",
  },
  openGraph: {
    title: "Newfoundland and Labrador – Notice Period Calculator | Legal Calculators",
    description: "Calculate notice period requirements for residential and employment terminations.",
    url: "https://your-domain.com/calculators/ca/nl/notice-period",
  },
};
