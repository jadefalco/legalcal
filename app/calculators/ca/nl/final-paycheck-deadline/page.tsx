...
export const metadata: Metadata = {
  title: "Newfoundland and Labrador – Final Paycheck Deadline Calculator",
  description: "Calculate final paycheck deadlines and accrued vacation payouts.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nl/final-paycheck-deadline",
  },
  openGraph: {
    title: "Newfoundland and Labrador – Final Paycheck Deadline Calculator | Legal Calculators",
    description: "Calculate final paycheck deadlines and accrued vacation payouts.",
    url: "https://your-domain.com/calculators/ca/nl/final-paycheck-deadline",
  },
};
