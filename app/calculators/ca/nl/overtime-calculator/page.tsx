...
export const metadata: Metadata = {
  title: "Newfoundland and Labrador – Overtime Calculator Calculator",
  description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/nl/overtime-calculator",
  },
  openGraph: {
    title: "Newfoundland and Labrador – Overtime Calculator Calculator | Legal Calculators",
    description: "Estimate overtime pay rules and eligibility for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/nl/overtime-calculator",
  },
};
