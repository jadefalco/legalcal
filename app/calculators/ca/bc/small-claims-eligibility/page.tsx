...
export const metadata: Metadata = {
  title: "British Columbia – Small Claims Eligibility Calculator",
  description: "Explain small claims court eligibility, limits, and filing procedures.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/bc/small-claims-eligibility",
  },
  openGraph: {
    title: "British Columbia – Small Claims Eligibility Calculator | Legal Calculators",
    description: "Explain small claims court eligibility, limits, and filing procedures.",
    url: "https://your-domain.com/calculators/ca/bc/small-claims-eligibility",
  },
};
