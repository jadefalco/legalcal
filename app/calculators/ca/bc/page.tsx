...
export const metadata: Metadata = {
  title: "British Columbia Legal Calculators",
  description:
    "Free legal calculators for British Columbia. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/bc",
  },
  openGraph: {
    title: "British Columbia Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for British Columbia. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/ca/bc",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: "https://your-domain.com/calculators/ca/bc",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          ...
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for British Columbia. Estimate deadlines,
            notice periods, and eligibility under British Columbia law.
          </p>
          <div
