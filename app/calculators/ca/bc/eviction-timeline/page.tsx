...
export const metadata: Metadata = {
  title: "British Columbia – Eviction Timeline Calculator",
  description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/bc/eviction-timeline",
  },
  openGraph: {
    title: "British Columbia – Eviction Timeline Calculator | Legal Calculators",
    description: "Calculate eviction timelines and key deadlines for your jurisdiction.",
    url: "https://your-domain.com/calculators/ca/bc/eviction-timeline",
  },
};
