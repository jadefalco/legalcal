...
export const metadata: Metadata = {
  title: "British Columbia – Rent Increase Limits Calculator",
  description: "Explain rent increase limits, notice requirements, and exemption rules.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/bc/rent-increase-limits",
  },
  openGraph: {
    title: "British Columbia – Rent Increase Limits Calculator | Legal Calculators",
    description: "Explain rent increase limits, notice requirements, and exemption rules.",
    url: "https://your-domain.com/calculators/ca/bc/rent-increase-limits",
  },
};
