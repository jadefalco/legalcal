...
const province: CAProvince = caProvinces["ab"];
const theme: Theme = getTheme("ca", "ab");

export const metadata: Metadata = {
  title: "Alberta – Small Claims Eligibility Calculator",
  description: "Explain small claims court eligibility, limits, and filing procedures.",
  alternates: {
    canonical: "https://your-domain.com/calculators/ca/ab/small-claims-eligibility",
  },
  openGraph: {
    title: "Alberta – Small Claims Eligibility Calculator | Legal Calculators",
    description: "Explain small claims court eligibility, limits, and filing procedures.",
    url: "https://your-domain.com/calculators/ca/ab/small-claims-eligibility",
  },
};
