...
export const metadata: Metadata = {
  title: "Ontario Small Claims Eligibility Checker",
  description:
    "Ontario Small Claims eligibility checker coming soon. Use our BC Small Claims eligibility checker in the meantime.",
  alternates: {
...
export default function OntarioSmallClaimsPlaceholder() {
  return (
    <div className="max-w-5xl mx-auto px-6 py-10">
      <h1 className="text-3xl md:text-4xl font-serif text-navy mb-3">
        Ontario Small Claims Eligibility Checker
      </h1>
