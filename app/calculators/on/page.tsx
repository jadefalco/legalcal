...
export const metadata: Metadata = {
  title: "Ontario Calculators",
  description:
    "Ontario legal calculators are coming soon. Check back for notice periods, eviction timelines, security deposit deadlines, employment termination, and Small Claims tools.",
  alternates: {
    canonical: "https://your-domain.com/calculators/on",
  },
  openGraph: {
    title: "Ontario Calculators | BC Legal Calculators",
    description:
      "Ontario legal calculators are coming soon. Notice periods, eviction timelines, security deposits, employment termination, and Small Claims tools.",
    url: "https://your-domain.com/calculators/on",
  },
  robots: {
    index: true,
    follow: true,
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          ...
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Ontario legal calculators are currently in development. Explore our available British Columbia calculators below, or check back soon for Ontario tools.
          </p>
