...
export default function RentIncreaseLimitsCalculator({
  initialProvince,
}: {
  ...
  return (
    <div className="space-y-8">
      <LCSection
        ...
        description="Select a province to view rent increase limits rules and calculate deadlines."
        icon={CalculatorIcon}
        theme={theme}
      />
      ...
      <LCCard theme={theme} className="space-y-6">
        ...
        <Link href={`/calculators/ca/${provinceCode}/rent-increase-limits`}>
          <LCButton variant="primary" theme={theme}>
            <ArrowRightCircleIcon className="w-4 h-4" />
            View Province-Specific Rent Increase Limits Calculator
          </LCButton>
        </Link>
      </LCCard>
    </div>
