  ...
  return (
    <div className="space-y-8">
      <LCSection
        ...
        description="Select a province to view notice period rules and calculate deadlines."
        icon={CalculatorIcon}
        theme={theme}
      />
      ...
      <LCCard theme={theme} className="space-y-6">
        ...
        <Link href={`/calculators/ca/${provinceCode}/notice-period`}>
          <LCButton variant="primary" theme={theme}>
            <ArrowRightCircleIcon className="w-4 h-4" />
            View Province-Specific Notice Period Calculator
          </LCButton>
        </Link>
      </LCCard>
    </div>
