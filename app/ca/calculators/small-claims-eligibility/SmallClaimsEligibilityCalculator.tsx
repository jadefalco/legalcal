...
export default function SmallClaimsEligibilityCalculator({
  initialProvince,
}: {
  ...
  return (
    <div className="space-y-8">
      <LCSection
        ...
        description="Select a province to view small claims eligibility rules and calculate deadlines."
        icon={CalculatorIcon}
        theme={theme}
      />
      ...
      <LCCard theme={theme} className="space-y-6">
        ...
        <Link href={`/calculators/ca/${provinceCode}/small-claims-eligibility`}>
          <LCButton variant="primary" theme={theme}>
            <ArrowRightCircleIcon className="w-4 h-4" />
            View Province-Specific Small Claims Eligibility Calculator
          </LCButton>
        </Link>
      </LCCard>
    </div>
