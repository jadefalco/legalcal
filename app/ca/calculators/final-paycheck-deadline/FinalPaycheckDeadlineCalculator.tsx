  ...
  return (
    <div className="space-y-8">
      <LCSection
        ...
        description="Select a province to view final paycheck deadline rules and calculate deadlines."
        icon={CalculatorIcon}
        theme={theme}
      />
      ...
      <LCCard theme={theme} className="space-y-6">
        ...
        <Link href={`/calculators/ca/${provinceCode}/final-paycheck-deadline`}>
          <LCButton variant="primary" theme={theme}>
            <ArrowRightCircleIcon className="w-4 h-4" />
            View Province-Specific Final Paycheck Deadline Calculator
          </LCButton>
        </Link>
      </LCCard>
    </div>
