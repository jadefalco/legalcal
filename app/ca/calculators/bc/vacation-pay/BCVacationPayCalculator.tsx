...
export default function BCVacationPayCalculator() {
  ...
  const rule = getRuleFromBundle("bc", "vacation-pay");
  ...
  return (
    <div className="space-y-8">
      <LCSection
        title="BC Vacation Pay Calculator"
        description="Calculate vacation pay entitlements under the BC Employment Standards Act."
        icon={SunIcon}
        theme={theme}
      />
      ...
      <LCCard theme={theme} className="space-y-5">
        <p className="text-sm text-slate-600">
          Enter your total wages and years of service to calculate your BC
      ...
      <LCCard theme={theme} className="space-y-3">
        ...
        <ul className="list-disc list-inside text-sm text-slate-700 space-y-1">
          ...
          <li>Based on BC Employment Standards Act §45–§58</li>
        </ul>
      </LCCard>
    </div>
  );
