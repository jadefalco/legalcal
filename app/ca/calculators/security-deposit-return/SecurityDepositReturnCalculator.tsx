...
export default function SecurityDepositReturnCalculator({
  initialProvince,
}: {
  ...
  return (
    <div className="space-y-8">
      <LCSection
        ...
        description="Select a province to view security deposit return rules and calculate deadlines."
        icon={CalculatorIcon}
        theme={theme}
      />
      ...
      <LCCard theme={theme} className="space-y-6">
        ...
        <Link href={`/calculators/ca/${provinceCode}/security-deposit-return`}>
          <LCButton variant="primary" theme={theme}>
            <ArrowRightCircleIcon className="w-4 h-4" />
            View Province-Specific Security Deposit Return Calculator
          </LCButton>
        </Link>
      </LCCard>
    </div>
