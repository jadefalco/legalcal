...
export default function ABTerminationPayCalculator() {
  ...
  const rule = getRuleFromBundle("ab", "termination-pay");
  ...
  function handleCalculate() {
    ...
    let noticePeriod = "";
    if (weeks === 0) {
      noticePeriod = "No termination pay required (less than 90 days).";
    } else if (weeks === 1) {
      noticePeriod = "1 week of pay required (90 days to 2 years).";
    } else if (weeks === 2) {
      noticePeriod = "2 weeks of pay required (2–4 years).";
    } else {
  ...
  return (
    <div className="space-y-8">
      <LCSection
        title="AB Termination Pay Calculator"
        description="Calculate termination pay entitlements under the Alberta Employment Standards Code based on length of service."
        icon={UserMinusIcon}
        theme={theme}
      />
      ...
      <LCCard theme={theme} className="space-y-5">
        <p className="text-sm text-slate-600">
          ...
          Alberta termination pay entitlement.
        </p>
          ...
          {result.weeks === 8 && (
            <div className="p-3 bg-amber-50 rounded-lg flex items-start gap-2">
              ...
              <p className="text-sm text-amber-800">
                Maximum termination pay reached. Alberta law caps termination
                pay at 8 weeks.
              </p>
            </div>
          )}
      ...
      <LCCard theme={theme} className="space-y-3">
        <h4 className="font-semibold text-slate-800 text-sm flex items-center gap-2">
          <InformationCircleIcon className="w-4 h-4 text-blue-500" />
          About Alberta Termination Pay
        </h4>
        <ul className="list-disc list-inside text-sm text-slate-700 space-y-1">
          <li>90 days to 2 years: 1 week&apos;s wages</li>
          <li>2–4 years: 2 weeks&apos; wages</li>
          <li>4–6 years: 4 weeks&apos; wages</li>
          <li>6–8 years: 5 weeks&apos; wages</li>
          <li>8–10 years: 6 weeks&apos; wages</li>
          <li>10+ years: 8 weeks&apos; wages</li>
