  ...
  return (
    <div className="space-y-8">
      <LCSection
        ...
        description="Select a province to generate a jurisdiction-specific eviction notice document."
      ...
      <LCCard theme={theme} className="space-y-6">
        ...
        <Link href={`/ca/provinces/${provinceCode}/eviction-notice`}>
          <LCButton variant="primary" theme={theme}>
            <ArrowRightCircleIcon className="w-4 h-4" />
            View Eviction Notice Rules
          </LCButton>
        </Link>
      </LCCard>
    </div>
