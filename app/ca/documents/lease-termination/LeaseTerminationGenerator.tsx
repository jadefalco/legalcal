...
export default function LeaseTerminationGenerator({
  initialProvince,
}: {
  ...
  return (
    <div className="space-y-8">
      <LCSection
        ...
        description="Select a province to generate a jurisdiction-specific lease termination document."
      ...
      <LCCard theme={theme} className="space-y-6">
        ...
        <Link href={`/ca/provinces/${provinceCode}/lease-termination`}>
          <LCButton variant="primary" theme={theme}>
            <ArrowRightCircleIcon className="w-4 h-4" />
            View Lease Termination Rules
          </LCButton>
        </Link>
      </LCCard>
    </div>
