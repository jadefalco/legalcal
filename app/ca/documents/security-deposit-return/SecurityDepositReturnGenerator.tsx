...
export default function SecurityDepositReturnGenerator({
  initialProvince,
}: {
  ...
  return (
    <div className="space-y-8">
      <LCSection
        ...
        description="Select a province to generate a jurisdiction-specific security deposit return document."
      ...
      <LCCard theme={theme} className="space-y-6">
        ...
        <Link href={`/ca/provinces/${provinceCode}/security-deposit-return`}>
          <LCButton variant="primary" theme={theme}>
            <ArrowRightCircleIcon className="w-4 h-4" />
            View Security Deposit Return Rules
          </LCButton>
        </Link>
      </LCCard>
    </div>
