...
export const metadata: Metadata = {
  ...
  description:
    "Free legal calculators for STATE_NAME. Eviction timelines, notice periods, security deposits, employment termination, and more.",
  alternates: {
    canonical: "https://your-domain.com/calculators/us/STATE_SLUG",
  },
  openGraph: {
    title: "STATE_NAME Legal Calculators | Legal Calculators",
    description:
      "Free legal calculators for STATE_NAME. Eviction timelines, notice periods, security deposits, employment termination, and more.",
    url: "https://your-domain.com/calculators/us/STATE_SLUG",
  },
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 4,
      name: "STATE_NAME",
      item: "https://your-domain.com/calculators/us/STATE_SLUG",
    },
  ],
};
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        <div className="mb-10">
          ...
          <p className="text-gray-600 font-sans text-base md:text-lg max-w-2xl">
            Free online legal calculators for STATE_NAME. Estimate deadlines,
            notice periods, and eligibility under STATE_NAME law.
          </p>
          <div
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {calculators.map((calc) => (
            <Link
              key={calc.slug}
              href={`/calculators/us/STATE_SLUG/${calc.slug}`}
